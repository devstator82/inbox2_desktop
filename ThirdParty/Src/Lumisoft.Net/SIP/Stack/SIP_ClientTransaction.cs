            ...
            */
            ...
            lock(this.SyncRoot){
                if(this.State == SIP_TransactionState.Calling){
                    ...
                    // Log
                    if(this.Stack.Logger != null){
                        this.Stack.Logger.AddText(this.ID,"Transaction [branch='" + this.ID + "';method='" + this.Method + "';IsServer=false] timer A(INVITE request retransmission) updated, will triger after " + m_pTimerA.Interval + ".");
                    }
                }
            }
        }
            ...
            */
            ...
            lock(this.SyncRoot){
                if(this.State == SIP_TransactionState.Trying){
                    ...
                    // Log
                    if(this.Stack.Logger != null){
                        this.Stack.Logger.AddText(this.ID,"Transaction [branch='" + this.ID + "';method='" + this.Method + "';IsServer=false] timer E(Non-INVITE request retransmission) updated, will triger after " + m_pTimerE.Interval + ".");
                    }
                }
            }
        }
                    ...
                    lock(this.SyncRoot){
                        ...
                        if(this.Method == SIP_Methods.INVITE){
                            ...
                            */
                            ...
                            if(!this.Flow.IsReliable){
                                ...
                                // Log
                                if(this.Stack.Logger != null){
                                    this.Stack.Logger.AddText(this.ID,"Transaction [branch='" + this.ID + "';method='" + this.Method + "';IsServer=false] timer A(INVITE request retransmission) started, will triger after " + m_pTimerA.Interval + ".");
                                }
                            }
                            ...
                            // Log
                            if(this.Stack.Logger != null){
                                this.Stack.Logger.AddText(this.ID,"Transaction [branch='" + this.ID + "';method='" + this.Method + "';IsServer=false] timer B(INVITE calling state timeout) started, will triger after " + m_pTimerB.Interval + ".");
                            }
                        }
                        ...
                        #region Non-INVITE
                            ...
                            */
                            ...
                            // Log
                            if(this.Stack.Logger != null){
                                this.Stack.Logger.AddText(this.ID,"Transaction [branch='" + this.ID + "';method='" + this.Method + "';IsServer=false] timer F(Non-INVITE trying,proceeding state timeout) started, will triger after " + m_pTimerF.Interval + ".");
                            }
                            ...
                            if(!this.Flow.IsReliable){ 
                                ...
                                // Log
                                if(this.Stack.Logger != null){
                                    this.Stack.Logger.AddText(this.ID,"Transaction [branch='" + this.ID + "';method='" + this.Method + "';IsServer=false] timer E(Non-INVITE request retransmission) started, will triger after " + m_pTimerE.Interval + ".");
                                }
                            }
                        }
                ...
                if(this.Method == SIP_Methods.INVITE){
                    ...
                    if(this.State == SIP_TransactionState.Calling){
                        ...
                        if(m_pTimerA != null){
                            ...
                            // Log
                            if(this.Stack.Logger != null){
                                this.Stack.Logger.AddText(this.ID,"Transaction [branch='" + this.ID + "';method='" + this.Method + "';IsServer=false] timer A(INVITE request retransmission) stoped.");
                            }
                        }
                        if(m_pTimerB != null){
                            m_pTimerB.Dispose();
                            ...
                            // Log
                            if(this.Stack.Logger != null){
                                this.Stack.Logger.AddText(this.ID,"Transaction [branch='" + this.ID + "';method='" + this.Method + "';IsServer=false] timer B(INVITE calling state timeout) stoped.");
                            }
                        }
                        ...
                        // 3xx - 6xx response.
                            ...
                            */
                            ...
                            // Log
                            if(this.Stack.Logger != null){
                                this.Stack.Logger.AddText(this.ID,"Transaction [branch='" + this.ID + "';method='" + this.Method + "';IsServer=false] timer D(INVITE 3xx - 6xx response retransmission wait) started, will triger after " + m_pTimerD.Interval + ".");
                            }
                ...
                */
                    ...
                    if(this.State == SIP_TransactionState.Trying){
                        ...
                        if(m_pTimerE != null){
                            ...
                            // Log
                            if(this.Stack.Logger != null){
                                this.Stack.Logger.AddText(this.ID,"Transaction [branch='" + this.ID + "';method='" + this.Method + "';IsServer=false] timer E(Non-INVITE request retransmission) stoped.");
                            }
                        }
                        ...
                        // 2xx - 6xx response.
                            ...
                            if(m_pTimerF != null){
                                ...
                                // Log
                                if(this.Stack.Logger != null){
                                    this.Stack.Logger.AddText(this.ID,"Transaction [branch='" + this.ID + "';method='" + this.Method + "';IsServer=false] timer F(Non-INVITE trying,proceeding state timeout) stoped.");
                                }
                            }
                            ...
                            */
                            ...
                            // Log
                            if(this.Stack.Logger != null){
                                this.Stack.Logger.AddText(this.ID,"Transaction [branch='" + this.ID + "';method='" + this.Method + "';IsServer=false] timer K(Non-INVITE 3xx - 6xx response retransmission wait) started, will triger after " + m_pTimerK.Interval + ".");
                            }
