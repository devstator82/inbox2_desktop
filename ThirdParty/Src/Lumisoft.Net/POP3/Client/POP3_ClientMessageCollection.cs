...
namespace LumiSoft.Net.POP3.Client
{
    ...
    /// </summary>
	public class POP3_ClientMessageCollection : IEnumerable<POP3_ClientMessage>, IDisposable
    {
    	...
    	IEnumerator<POP3_ClientMessage> IEnumerable<POP3_ClientMessage>.GetEnumerator()
    	{
