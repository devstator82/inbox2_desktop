...
namespace Inbox2.Framework.Plugins.SharedControls.Utils
{
	[Export(typeof(IDocHostUIHandler))]
	public class DocHostUIHandler : IDocHostUIHandler
	{
		private readonly ObjectForScriptingHelper helper = new ObjectForScriptingHelper();
