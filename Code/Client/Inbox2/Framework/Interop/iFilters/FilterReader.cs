...
using Inbox2.Framework.Interop.iFilters;

namespace Inbox2.Framework.Interop.iFilters
{
	/// <summary>
	...
	public class FilterReader : TextReader
	{
		...
		public FilterReader(IFilter filter)
		{
			_filter = filter;
		}

		public static IFilter GetFilter(string filename, string filterExtension)
		{
			return FilterLoader.LoadAndInitIFilter(filename, filterExtension);
		}
	}
}