...
namespace Inbox2.Framework.Interop.TaskbarNotification.Interop
{
  /// <summary>
  ...
  public struct NotifyIconData
  {
    ...
    /// of the tray icon. If this member is non-NULL and the <see cref="Inbox2.UI.TaskbarNotification.Interop.BalloonFlags.User"/>
